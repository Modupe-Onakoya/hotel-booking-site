...
const Footer = () => {
    return (
        <div className='mt-20 md:mt-30 px-4 py-4 bg-black'>
            <footer className="bg-white w-full max-w-[1350px] mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">

                    <div className="lg:col-span-3 space-y-6">
                        <a href="#" className="block bg-black w-fit p-2">
                            <img src={assets.logo} alt="" />
                        </a>
                        <p className="text-sm/6 text-neutral-600 max-w-96">Discover the worlds greatest extraordinary places to stay, from boutique, hotel to luxury villas.</p>
                    ...
                    <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-28 items-start">
                        ...
                        <div className="col-span-2 md:col-span-1">
                            <h3 className="font-medium text-sm mb-4  text-neutral-800">Company</h3>
                            <ul className="space-y-3 text-sm text-neutral-800">
                                <li><a href="#" className="hover:text-neutral-700">Help center</a></li>
                                <li><a href="#" className="hover:text-neutral-700">Saftey information</a></li>
                                <li className="flex items-center gap-2">
                                    <a href="#" className="hover:text-neutral-700">Cancellation OPtions</a>
                ...
                <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-neutral-300 flex justify-between items-center">
                    <p className="text-neutral-600 text-sm">© 2025 Modupe Design</p>
