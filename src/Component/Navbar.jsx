    ...
    return (
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}>
            ...
            <div className="hidden md:flex items-center gap-4 lg:gap-8">
                ...
                {user && <button className={`border px-4 py-1 text-sm font-light rounded-full cursor-pointer ${isScrolled ? 'text-black' : 'text-white'} transition-all`}>
                    Dashboard
                </button>}
            ...
            {
                user ? <div className="hidden md:block"><UserButton >
                    <UserButton.MenuItems>
                        <UserButton.Action label="My booking" labelIcon={<Bookings />} onClick={() => navigate('/my-bookings')} />
                        {/* <UserButton.UserProfileLink labelIcon={<Bookings />} /> */}
                    </UserButton.MenuItems>
                </UserButton>
            ...
            {/* Mobile Menu */}
            <div className={`fixed top-0 left-0 w-full h-screen bg-white text-base flex flex-col md:hidden items-center justify-center gap-6 font-medium text-gray-800 transition-all duration-500 ${isMenuOpen ? "translate-y-0" : "-translate-y-full"}`}>
